...
fn validate_text_block_receipt(
    plan: &TextBlockPlan,
    previous: Option<&TextBlockReceipt>,
...
struct TextBlockDocument {
    original: Option<Vec<u8>>,
    permissions: Option<Permissions>,
    source: String,
}

fn read_text_block_document(path: &Path) -> Result<TextBlockDocument, ConfigurationError> {
...
fn desired_text_block(plan: &TextBlockPlan) -> String {
    format!(
        "{}\n{}\n{}\n",
        plan.begin,
...
fn prepare_text_block_replacement(
    plan: &TextBlockPlan,
    source: &str,
    previous: Option<&TextBlockReceipt>,
    desired: &str,
