...
fn kimi_model_table(model: &CodingModelProfile) -> Result<(String, toml::Value), String> {
...
fn kimi_model_limits(model: &CodingModelProfile) -> Result<(i64, i64), String> {
...
fn kimi_model_capabilities(model: &CodingModelProfile) -> Vec<toml::Value> {
