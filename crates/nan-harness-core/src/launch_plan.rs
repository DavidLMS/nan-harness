...
pub use schema::{
    ...
    CLAUDE_AVAILABLE_MODELS_PLACEHOLDER, CLAUDE_MODEL_PRESENTATIONS_PLACEHOLDER,
    CLINE_MODEL_CATALOG_PLACEHOLDER, CODEX_HOME_ARTIFACT_PLACEHOLDER, CODEX_HOME_OVERLAY_ID,
    CODEX_HOME_PLACEHOLDER, CODEX_MODEL_CATALOG_PLACEHOLDER, CODEX_PROFILE_ARTIFACT_ID,
    CleanupPolicy, ConfigurationOverlay, DEEPSEEK_MODEL_CATALOG_PLACEHOLDER, EnvironmentOverlay,
